...
- 设计反思：
	...
	- 基础数据类图补充获取子元素的总数方法
	- 时间工具类图补充时间戳换算方法
	- 替换原时间戳方法 L:\Doc\Git\OpenShiftBaseNodejs\MyBlog\web\js\index.js
	- 页面工具类图补充指纹方法
	- 字符工具类图补充二进制字符转16进制数方法
	- 替换指纹方法 L:\Doc\Git\OpenShiftBaseNodejs\web\js\trace.js
...
- 设计反思：
	...
	- 替换原数据库类 L:\Doc\Git\OpenShiftBaseNodejs\index.js ；L:\Doc\Git\OpenShiftBaseNodejs\MyBlog\index.js ； L:\Doc\Git\OpenShiftBaseNodejs\Gu\index.js
