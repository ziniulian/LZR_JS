...
LZR.Pro.Gu.InfTest.prototype.hdDat = function ()/*as:Array*/ {
	var i, o, r = [];
	this.getPro();
	for (i = this.cp.p > this.cp.v ? this.cp.p : this.cp.v; i < dco.sr.length; i ++) {
...
// 初始化参数
LZR.Pro.Gu.InfTest.prototype.initPro = function (doe/*as:Object*/) {
	var i, a, d, p, s;
	a = doe.childNodes;
	p = this.getProInit();
...
// 条件匹配
LZR.Pro.Gu.InfTest.prototype.match = function (o/*as:Object*/)/*as:boolean*/ {
	if (
		o.v > o.vh	// 演示放量
	) {
		return true;
