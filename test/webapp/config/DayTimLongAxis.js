function webapp () {
	return {
		...
		tools: {
			Tb: "LZR.HTML.Base.Ctrl.TimBase.DayTim.DayTimLongAxis",
		...
		fun: function (obj) {
			...
			*/
			...
			this.setTyp = function(m) {
				switch (m) {
					case "D":
						this.doe.getById("hct_DayTimHourBar").dat.hct_num.vcStep.set(24 * 3600 * 1000);
						break;
					case "H":
						this.doe.getById("hct_DayTimHourBar").dat.hct_num.vcStep.set(3600 * 1000);
						break;
				}
			};
